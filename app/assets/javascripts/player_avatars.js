$(document).ready(function() {
		...
		$(".player-avatar").each(function() {
			...
			$(this).dropzone({
				...
				addedfile: function(file) {
					$(".player-update", $(this.element).parent().siblings("form")).attr("disabled", "disabled");
			        var _this = this;
      			...
      			complete: function(file) {
      				$(".player-update", $(this.element).parent().siblings("form")).removeAttr("disabled");
        			if (file._removeLink) {
	...
	window.applyDropZoneToPlayerAvatars = applyDropZoneToPlayerAvatars;
});